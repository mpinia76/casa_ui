...
namespace Casa\UI\components\form\caja;

use Casa\UI\service\finder\SucursalFinder;

use Casa\UI\service\finder\EmpleadoFinder;

use Casa\UI\components\filter\model\UIEmpleadoCriteria;

use Casa\UI\components\filter\model\UISucursalCriteria;
...
//		}
	...
	public function getFechaEditable(){
		return CasaUIUtils::isAdminLogged();
	}
