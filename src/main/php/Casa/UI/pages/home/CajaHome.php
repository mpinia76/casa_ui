...
class CajaHome extends AdminHome{
	...
	public function __construct(){
		...
		if( CasaUIUtils::isCajaSelected() )
			$this->setCaja(  UIServiceFactory::getUICajaService()->get(  CasaUIUtils::getCaja()->getOid()) );
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		if( CasaUIUtils::isCajaSelected() ){
			...
			//$xtpl->assign("caja_legend", CasaUIUtils::formatMessage( $this->localize("empleado_home.caja.legend"), array($caja->getNumero())) );
	...
	public function getTitle(){
			...
			$nombre ="";
		return CasaUIUtils::formatMessage( $this->localize("empleado_home.title"), array($nombre)) ;
	}
