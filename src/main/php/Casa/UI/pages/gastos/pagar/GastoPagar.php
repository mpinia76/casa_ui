<?php
namespace Casa\UI\pages\gastos\pagar;
...
class GastoPagar extends CasaPage{
...
//
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		/*if( CasaUIUtils::isCajaSelected() ){
			$xtpl->assign( "linkPagarEfectivo", $this->getLinkActionPagarGasto($this->getGasto(), CasaUIUtils::getCaja(), $this->getBackTo()) );
			$xtpl->parse("main.forma_pago_caja");
		}*/

		if( CasaUIUtils::isAdminLogged() ){
			/*$xtpl->assign( "linkPagarCajaChica", $this->getLinkActionPagarGasto($this->getGasto(), CasaUtils::getCuentaCajaChica(), $this->getBackTo()) );
			...
			/*$xtpl->assign( "linkPagarBAPRO", $this->getLinkActionPagarGasto($this->getGasto(), CasaUtils::getCuentaBAPROCtaCte(), $this->getBackTo()) );
			$xtpl->assign("lbl_bapro",'Cta. Cte.');
			$xtpl->parse("main.forma_pago_bapro");
			$xtpl->assign( "linkPagarBAPRO", $this->getLinkActionPagarGasto($this->getGasto(), CasaUtils::getCuentaARISTEGUI1(), $this->getBackTo()) );
			$xtpl->assign("lbl_bapro",'Aristegui 1');
			$xtpl->parse("main.forma_pago_bapro");
			$xtpl->assign( "linkPagarBAPRO", $this->getLinkActionPagarGasto($this->getGasto(), CasaUtils::getCuentaBAPROCajaAhorro(), $this->getBackTo()) );
			$xtpl->assign("lbl_bapro",'Caja de Ahorro');
			$xtpl->parse("main.forma_pago_bapro");
			$xtpl->assign( "linkPagarBAPRO", $this->getLinkActionPagarGasto($this->getGasto(), CasaUtils::getCuentaARISTEGUI2(), $this->getBackTo()) );
