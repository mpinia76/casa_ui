...
use Casa\UI\components\grid\formats\GridEstadoVentaFormat;

use Casa\UI\components\filter\model\UIVentaCriteria;
...
class VentaGridModel extends EntityGridModel{
	...
	public function getRowStyleClass($item){
		...
		return CasaUIUtils::getEstadoVentaCss($item->getEstado());
