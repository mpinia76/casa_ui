...
namespace Casa\UI\components\boxes\banco;
...
class BancoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		if( !empty($banco )){
			...
			$xtpl->assign("saldo",  CasaUIUtils::formatMontoToView($banco->getSaldo()) );
			$xtpl->assign("saldoInicial",  CasaUIUtils::formatMontoToView($banco->getSaldoInicial()) );
