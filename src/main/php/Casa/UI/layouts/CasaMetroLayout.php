...
class CasaMetroLayout extends RastyLayout{
	...
	public function getContent(){
		...
		$xtpl = $this->getXTemplate( dirname(__DIR__) . "/layouts/CasaMetroLayout.htm" );
...
// 		$this->addStyle( "$webPath/metro/less/metro-bootstrap.less");
		...
		$this->addStyle( "$webPath/metro/css/casa_forms.css");
