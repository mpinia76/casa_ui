<?php
namespace Casa\UI\service\finder;

use Casa\UI\utils\CasaUIUtils;

use Casa\UI\components\filter\model\UICajaCriteria;
...
class CajaFinder implements  IAutocompleteFinder {
	...
	function getEntityLabel( $entity ){
		...
		if( !empty( $entity)  ){
			...
			$params = array( $entity->getNumero(), $entity->getCajero(), CasaUIUtils::formatMontoToView($entity->getSaldo()) );
			return CasaUIUtils::formatMessage( $msg, $params);
		}
