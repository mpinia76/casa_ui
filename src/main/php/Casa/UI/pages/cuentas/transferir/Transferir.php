<?php
namespace Casa\UI\pages\cuentas\transferir;


use Casa\UI\components\filter\model\UICuentaCorrienteCriteria;

use Casa\UI\service\UICuentaCorrienteService;

use Casa\UI\components\filter\model\UIBancoCriteria;

use Casa\UI\components\filter\model\UICuentaSocioCriteria;

use Casa\UI\service\UISucursalService;

use Casa\UI\components\filter\model\UICuentaCriteria;

use Casa\UI\service\finder\CuentaFinder;
...
class Transferir extends CasaPage{
	...
	protected function parseLabels(XTemplate $xtpl){
		...
		$xtpl->assign("legend",  $this->localize( "casa.transferir.legend" ) );
	...
	public function getTitle(){
		return $this->localize("casa.transferir.title") ;
	}
	...
	public function getDestinos(){
		...
		$casaCorrientes = UIServiceFactory::getUICuentaCorrienteService()->getList( new UICuentaCorrienteCriteria());
		...
		$destinos = array_merge($destinos, $casaCorrientes);*/
