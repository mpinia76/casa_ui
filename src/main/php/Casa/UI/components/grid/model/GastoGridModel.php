<?php
namespace Casa\UI\components\grid\model;
...
use Casa\UI\components\grid\formats\GridImporteFormat;

use Casa\UI\components\grid\formats\GridEstadoGastoFormat;
...
//		//TODO esto setearlo en el .rasty
	...
	public function getRowStyleClass($item){
		...
		//return CasaUIUtils::getEstadoGastoCss($item->getEstado());
	...
	public function getHeaderContent(){
		...
		return 'Total: '.CasaUIUtils::formatMontoToView($service->getTotales($filter->getCriteria()));
	}
