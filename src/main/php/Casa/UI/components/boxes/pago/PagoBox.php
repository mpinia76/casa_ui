...
namespace Casa\UI\components\boxes\pago;
...
class PagoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "monto", CasaUIUtils::formatMontoToView( $this->getPago()->getMonto() ) );
		$xtpl->assign( "observaciones", $this->getPago()->getObservaciones() );
		$xtpl->assign( "fechaHora", CasaUIUtils::formatDateTimeToView($this->getPago()->getFechaHora()) );
